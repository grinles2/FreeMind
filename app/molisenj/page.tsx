...
export default function SimplePage() {
  return (
    <div className="relative min-h-screen bg-[#0b0014] text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-20 pb-20 gap-6">
        <motion.img
          src="/molisenj.jpeg"
        ...
        >
          <span className="line-through text-gray-500">Госпожа</span>{" "}
          <span className="text-[#d946ef] font-semibold">Главный Мужлан</span>{" "}
          проекта FreeMind
        </motion.p>
      </main>
